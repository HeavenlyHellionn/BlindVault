...
const KF = `@keyframes bvFade{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}} @keyframes bvFadeUp{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}} @keyframes bvScale{0%{transform:scale(0.8);opacity:0}60%{transform:scale(1.06)}100%{transform:scale(1);opacity:1}} @keyframes bvGlow{0%,100%{box-shadow:0 0 6px rgba(192,64,255,0.3)}50%{box-shadow:0 0 24px rgba(192,64,255,0.9)}} @keyframes bvGlowGold{0%,100%{box-shadow:0 0 6px rgba(243,198,86,0.3)}50%{box-shadow:0 0 22px rgba(243,198,86,0.8)}} @keyframes bvGlowRed{0%,100%{box-shadow:0 0 6px rgba(255,77,120,0.3)}50%{box-shadow:0 0 22px rgba(255,77,120,0.8)}} @keyframes bvBlink{0%,49%,100%{opacity:1}50%,99%{opacity:0}} @keyframes bvFloat{0%,100%{transform:translateY(0px)}50%{transform:translateY(-8px)}} @keyframes bvFloat2{0%,100%{transform:translateY(0px)}50%{transform:translateY(-5px)}} @keyframes bvWander{0%{transform:translateX(0px) scaleX(1)}49%{transform:translateX(60px) scaleX(1)}50%{transform:translateX(60px) scaleX(-1)}100%{transform:translateX(0px) scaleX(-1)}} @keyframes bvWander2{0%{transform:translateX(0px) scaleX(-1)}49%{transform:translateX(-50px) scaleX(-1)}50%{transform:translateX(-50px) scaleX(1)}100%{transform:translateX(0px) scaleX(1)}} @keyframes bvWander3{0%{transform:translateX(0px) translateY(0px)}25%{transform:translateX(30px) translateY(-10px)}50%{transform:translateX(60px) translateY(0px)}75%{transform:translateX(30px) translateY(10px)}100%{transform:translateX(0px) translateY(0px)}} @keyframes bvBob{0%,100%{transform:translateY(0px) rotate(0deg)}33%{transform:translateY(-6px) rotate(-3deg)}66%{transform:translateY(-3px) rotate(3deg)}} @keyframes bvSway{0%,100%{transform:rotate(-4deg)}50%{transform:rotate(4deg)}} @keyframes bvPulse{0%,100%{opacity:1}50%{opacity:0.45}} @keyframes bvShimmer{0%{background-position:-200% 0}100%{background-position:200% 0}} @keyframes confetti{0%{transform:translateY(-10px) rotate(0deg);opacity:1}100%{transform:translateY(110vh) rotate(720deg);opacity:0}} @keyframes ringOut{0%{transform:translate(-50%,-50%) scale(0.3);opacity:1}100%{transform:translate(-50%,-50%) scale(3);opacity:0}} @keyframes deathSink{0%{opacity:1;transform:scale(1) rotate(0deg)}100%{opacity:0;transform:scale(0.6) rotate(-15deg) translateY(40px)}} @keyframes wipeIn{0%{clip-path:inset(0 100% 0 0)}100%{clip-path:inset(0 0% 0 0)}} @keyframes wipeOut{0%{clip-path:inset(0 0 0 0);opacity:1}100%{clip-path:inset(0 0 0 100%);opacity:0}} @keyframes pixelDrop{0%{opacity:0;transform:scaleY(0)}100%{opacity:1;transform:scaleY(1)}} @keyframes scanMove{0%{transform:translateY(-100%)}100%{transform:translateY(100vh)}} @keyframes borderMarch{0%{background-position:0 0,100% 0,100% 100%,0 100%}100%{background-position:200px 0,100% 200px,-200px 100%,0 -200px}} @keyframes titleGlitch{0%,95%,100%{transform:translateX(0);text-shadow:0 0 20px rgba(192,64,255,0.8)}96%{transform:translateX(-3px);text-shadow:-3px 0 rgba(255,77,120,0.8),3px 0 rgba(0,232,122,0.8)}98%{transform:translateX(2px);text-shadow:2px 0 rgba(255,77,120,0.8),-2px 0 rgba(0,232,122,0.8)}} @keyframes hpFlash{0%,100%{filter:brightness(1)}50%{filter:brightness(2.5) saturate(2)}} @keyframes slideInLeft{from{transform:translateX(-30px);opacity:0}to{transform:translateX(0);opacity:1}} @keyframes slideInRight{from{transform:translateX(30px);opacity:0}to{transform:translateX(0);opacity:1}} @keyframes popIn{0%{transform:scale(0.5);opacity:0}70%{transform:scale(1.1)}100%{transform:scale(1);opacity:1}} @keyframes logSlide{from{opacity:0;transform:translateX(-8px)}to{opacity:1;transform:translateX(0)}}`;
...
const STORY_EVENTS=[
{id:“ambush”,title:“Ambush!”,icon:“⚡”,desc:“Something lunges from the dark. No time to think. How you respond sets the die for this fight.”,choices:[
{id:“fight”,label:“Stand your ground”,icon:“⚔️”,type:“combat”,effect:“normal”,die:10,dieLabel:“d10”,dieDesc:“Steady footing. High damage output.”,desc:“Face it head-on. Roll d10 for damage this room.”},
{id:“dodge”,label:“Roll aside”,icon:“💨”,type:“combat”,effect:“hero_guard”,die:6,dieLabel:“d6”,dieDesc:“Safe entry. Enemy misses round 1.”,desc:“Dodge the first blow. Enemy misses round 1. Roll d6 damage.”},
{id:“call_out”,label:“Shout a challenge”,icon:“📣”,type:“combat”,effect:“enemy_weakened”,die:8,dieLabel:“d8”,dieDesc:“Enemy starts weakened.”,desc:“Your war cry rattles it. Enemy starts weakened. Roll d8 damage.”},
]},
{id:“trap_room”,title:“Trapped Chamber”,icon:“🕸️”,desc:“The door clicks behind you. Pressure plates everywhere. How you handle it shapes your fighting form.”,choices:[
{id:“disarm”,label:“Carefully disarm”,icon:“🔧”,type:“skill_check”,effect:“safe”,die:8,dieLabel:“d8”,dieDesc:“Calm hands. Precise strikes ahead.”,desc:“Success: proceed safely. Fail: take 4 damage. d8 damage this fight.”},
{id:“rush”,label:“Rush straight through”,icon:“🏃”,type:“damage”,effect:“4”,die:12,dieLabel:“d12”,dieDesc:“Reckless charge. Massive damage potential.”,desc:“Take 4 damage. Adrenaline surge: roll d12 damage this room.”},
{id:“search”,label:“Search for a bypass”,icon:“🔍”,type:“heal”,effect:“3”,die:6,dieLabel:“d6”,dieDesc:“Rested but cautious.”,desc:“Find a hidden path. Heal 3 HP. Roll d6 damage this fight.”},
{id:“wait”,label:“Study the pattern”,icon:“👁️”,type:“combat”,effect:“enemy_exposed”,die:8,dieLabel:“d8”,dieDesc:“Studied approach. Enemy exposed.”,desc:“Spot the guardian’s weakness. It starts exposed. Roll d8 damage.”},
]},
{id:“merchant”,title:“Wandering Merchant”,icon:“🧙”,desc:“A hooded figure in the dark. Friend or foe — your call shapes what follows.”,choices:[
{id:“buy_potion”,label:“Buy a potion”,icon:“🧪”,type:“gain”,effect:“potion”,die:6,dieLabel:“d6”,dieDesc:“Steady and restocked.”,desc:“Gain 1 potion. Roll d6 damage in next fight.”},
{id:“trade_info”,label:“Ask for dungeon lore”,icon:“📜”,type:“info”,effect:“reveal”,die:8,dieLabel:“d8”,dieDesc:“Knowledge is power.”,desc:“Learn the boss weakness. Roll d8 damage next fight.”},
{id:“rob”,label:“Take what you need”,icon:“💀”,type:“combat”,effect:“ambush”,die:12,dieLabel:“d12”,dieDesc:“Violent opener. d12 damage.”,desc:“They weren’t a merchant. Fight starts now. Roll d12 damage.”},
]},
{id:“shrine”,title:“Ancient Shrine”,icon:“⛩️”,desc:“A crumbling altar pulses with faint energy. Your offering determines your edge.”,choices:[
{id:“pray”,label:“Offer blood”,icon:“🩸”,type:“damage_heal”,effect:“4_8”,die:10,dieLabel:“d10”,dieDesc:“The shrine rewards sacrifice.”,desc:“Lose 4 HP, gain 8 HP. The shrine blesses you: roll d10 damage.”},
{id:“desecrate”,label:“Smash the idol”,icon:“🔨”,type:“combat”,effect:“enemy_rage”,die:4,dieLabel:“d4”,dieDesc:“Guardian is enraged. You roll low.”,desc:“A guardian manifests — enraged. Roll d4 damage this fight.”},
{id:“meditate”,label:“Meditate at the shrine”,icon:“🧘”,type:“buff”,effect:“regen”,die:8,dieLabel:“d8”,dieDesc:“Focused and healing.”,desc:“Gain regen for 3 turns. Roll d8 damage next fight.”},
{id:“leave”,label:“Leave it alone”,icon:“🚪”,type:“skip”,effect:“none”,die:6,dieLabel:“d6”,dieDesc:“Standard odds. No risk taken.”,desc:“Move forward. Nothing happens. Roll d6 damage this room.”},
]},
{id:“survivor”,title:“Wounded Survivor”,icon:“🤕”,desc:“A dying adventurer against the wall. What you do next says something about you.”,choices:[
{id:“help”,label:“Use your potion on them”,icon:“🧪”,type:“sacrifice”,effect:“potion_for_buff”,die:10,dieLabel:“d10”,dieDesc:“Their knowledge sharpens you.”,desc:“Spend 1 potion. Gain their combat insight: +2 next attack, roll d10 damage.”},
{id:“take”,label:“Search their body”,icon:“🎒”,type:“gain”,effect:“potion”,die:6,dieLabel:“d6”,dieDesc:“Resourceful, if cold.”,desc:“Find a health potion. Roll d6 damage in next fight.”},
{id:“ignore”,label:“Keep moving”,icon:“👣”,type:“skip”,effect:“none”,die:8,dieLabel:“d8”,dieDesc:“Cold focus. You stay sharp.”,desc:“No time for sentiment. Your focus holds: roll d8 damage.”},
]},
{id:“fork”,title:“Split Passage”,icon:“🔀”,desc:“The corridor divides. Left smells of rot. Right glows faintly. Your path sets your dice.”,choices:[
{id:“left”,label:“Go left into the rot”,icon:“⬅️”,type:“combat”,effect:“enemy_buff”,die:12,dieLabel:“d12”,dieDesc:“Dangerous path. High reward.”,desc:“A stronger, well-rested enemy waits. But you roll d12 damage.”},
{id:“right”,label:“Go right toward the light”,icon:“➡️”,type:“heal”,effect:“5”,die:6,dieLabel:“d6”,dieDesc:“Safe path. Lower damage.”,desc:“A shrine room. Heal 5 HP. Roll d6 damage next fight.”},
{id:“both”,label:“Scout both before choosing”,icon:“🔍”,type:“info”,effect:“reveal”,die:8,dieLabel:“d8”,dieDesc:“Informed. Balanced strike.”,desc:“Map the area. See the boss room. Roll d8 damage.”},
]},
{id:“horror”,title:“The Whispering Dark”,icon:“🌑”,desc:“Something speaks your name from the walls. How you respond echoes into combat.”,choices:[
{id:“resist”,label:“Block it out”,icon:“🧠”,type:“buff”,effect:“resist”,die:8,dieLabel:“d8”,dieDesc:“Mental discipline holds.”,desc:“Gain +1 guard. Roll d8 damage this fight.”},
{id:“listen”,label:“Listen to the whispers”,icon:“👂”,type:“info”,effect:“reveal”,die:10,dieLabel:“d10”,dieDesc:“Dark knowledge. Sharper strikes.”,desc:“Disturbing but useful. Learn what’s ahead. Roll d10 damage.”},
{id:“run”,label:“Sprint through”,icon:“🏃”,type:“damage”,effect:“2”,die:4,dieLabel:“d4”,dieDesc:“Rattled. Shaking hands.”,desc:“Lose 2 HP from the shock. Rattled: only roll d4 damage.”},
]},
];
...
const [activeDie,setActiveDie]=useState(6);
const [activeDieLabel,setActiveDieLabel]=useState(“d6”);
const [activeDieDesc,setActiveDieDesc]=useState(“Standard damage die.”);
...
setVictoryBossName(””);setRevealedWeakness(false);setNextDmgBonus(0);setHpFlash(false);setActiveDie(6);setActiveDieLabel(“d6”);setActiveDieDesc(“Standard damage die.”);
...
setActiveDie(6);setActiveDieLabel(“d6”);setActiveDieDesc(“Standard damage die.”);
...
if(choice.die){setActiveDie(choice.die);setActiveDieLabel(choice.dieLabel||(“d”+choice.die));setActiveDieDesc(choice.dieDesc||””);}
...
const dmg=calcDmg(nh,ps,4,activeDie,hit.crit,flat,blueprint,kind);
const res=applyDmg(ne,dmg,false);
log.push({t:“hit”,m:`${nh.name} strikes for ${res.hd+res.sd} [${activeDieLabel}]${hit.crit?" CRIT!":""}`});
}
...
const dmg=calcDmg(nh,skill.accuracyStat,skill.basePower,skill.damageDie||activeDie,hit.crit,flat,blueprint,isMag?“magic”:“physical”);
const res=applyDmg(ne,dmg,false);
...
```
      ...
      <div style={{ background:CARD,border:`2px solid ${BD}`,boxShadow:"0 0 14px rgba(192,64,255,0.1)",padding:isM?10:14,display:"flex",justifyContent:"space-between",alignItems:"center",gap:8,flexWrap:"wrap",borderBottom:`3px solid ${isBoss?GOLD:G}`,animation:"bvFade 0.4s ease"}}>
        ...
        <div style={{display:"flex",gap:isM?8:16,alignItems:"center",flexWrap:"wrap"}}>
          {phase==="combat"&&(
            <div style={{textAlign:"center",border:`2px solid ${GOLD}`,background:"rgba(243,198,86,0.1)",padding:isM?"4px 8px":"6px 12px",borderRadius:2,animation:"bvGlowGold 2s ease infinite"}}>
              <div style={{fontFamily:P,fontSize:"6px",color:TM}}>ACTIVE DIE</div>
              <div style={{fontFamily:P,fontSize:isM?"11px":"14px",color:GOLD,marginTop:2}}>{activeDieLabel}</div>
            </div>
          )}
          {hero&&(
          ...
          {phase==="combat"&&(
            <div style={{ background:CARD,border:`2px solid ${BD}`,boxShadow:"0 0 14px rgba(192,64,255,0.1)",padding:isM?10:14,animation:"bvFade 0.5s ease"}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8,flexWrap:"wrap",gap:6}}>
                <div style={{fontFamily:P,fontSize:"7px",color:G}}>ACTIONS</div>
                <div style={{display:"flex",alignItems:"center",gap:6,border:`1px solid ${GOLD}`,padding:"3px 8px",background:"rgba(243,198,86,0.07)"}}>
                  <span style={{fontFamily:P,fontSize:"6px",color:TM}}>ROLLING</span>
                  <span style={{fontFamily:P,fontSize:"9px",color:GOLD,animation:"bvPulse 1.5s ease infinite"}}>{activeDieLabel}</span>
                  <span style={{fontFamily:V,fontSize:16,color:TM,opacity:0.8}}>{activeDieDesc}</span>
                </div>
              </div>
